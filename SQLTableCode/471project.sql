...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"73552649785d6b704124412c45344c74",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=471project&table=builds">
    `471project`.`builds`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=shop">
    `471project`.`shop`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=company">
    `471project`.`company`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=government">
    `471project`.`government`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=dependents">
    `471project`.`dependents`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=users">
    `471project`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=trainengineer">
    `471project`.`trainengineer`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=train">
    `471project`.`train`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=supplier">
    `471project`.`supplier`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=471project&table=repairservice">
    `471project`.`repairservice`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.NDcxcHJvamVjdA==" data-vpath="cm9vdA==.NDcxcHJvamVjdA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=471project"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=471project" title="Structure">471project</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cGFuZG9yYV9yZWFsX2VzdGF0ZQ==" data-vpath="cm9vdA==.cGFuZG9yYV9yZWFsX2VzdGF0ZQ==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=pandora_real_estate"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=pandora_real_estate" title="Structure">pandora_real_estate</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGVzdGRi" data-vpath="cm9vdA==.dGVzdGRi" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=testdb"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=testdb" title="Structure">testdb</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="73552649785d6b704124412c45344c74">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="471project" targettable="builds">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `builds`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="builds">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `builds`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="shop">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `shop`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="supplier">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `supplier`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="train">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `train`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="trainengineer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `trainengineer`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="company">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `company`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="government">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `government`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="government">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `government`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="dependents">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `dependents`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="company">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `shop` DROP `Field`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="471project" targettable="shop">
                            <div class="action_content">
